...
empresas = ["ibovespa", "petrobras-petr4", "magazine-luiza-mglu3", "itau-unibanco-itub4"] # IBOV , PETR4, MGLU3, ITUB4

base_url = "https://www.infomoney.com.br/cotacoes/b3/indice/"

output_file = "noticias_empresas.csv"
...
with open(output_file, mode="w", newline="", encoding="utf-8") as csvfile:
    ...
    for empresa in empresas:
        ...
        if response.status_code == 200:
            ...
            for article in articles[:10]: # MUDAR O NUMERO SE QUISER MENOS NOTICIAS POR EMPRESA(MÁXIMO 10)
